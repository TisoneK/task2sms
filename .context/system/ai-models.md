...
|---|---|---|---|---|
| Super Z | glm-5.2 (initially recorded as `unknown` because the system prompt states "built on the GLM model" without an exact version; corrected to `glm-5.2` on 2026-07-13 after the user stated the model in chat — per protocol precedence, user statement is authoritative) | 2026-07-13 | 2026-07-13 | 1 |
